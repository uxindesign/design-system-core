...
- **Componente Combobox.** Sincroniza 16 tokens `component.combobox.*` do Figma, `css/components/combobox.css`, `docs/combobox.html`, listbox/option com tokens locais + geometria `menu/item/*`, field compartilhado (ADR-020) e ARIA de combobox/listbox/option.
