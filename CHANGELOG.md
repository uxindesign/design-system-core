...
### Adicionado
- **Componente Accordion sincronizado a partir do Figma.** Adicionados tokens `component.accordion.*`, CSS gerado, API, registry e documentação de tokens a partir da run `2026-06-29-accordion`, mantendo `Focus Ring` com radius `16` e contratos anatômicos via camada Component.
